...
def add_note(out, instr, key_num, duration, bpm, volume):
    """ Adds a note from the given instrument to the specified stream
        ...
        key_num: the piano key number (A 440Hz is 49)
...
licks = [[[1, 0.25], [-1, 0.25], [1, 0.25], [1, 1.25]], [[-1, 0.5], [-1, 0.5], [-1, 0.5], [-1, 0.5]], [[4, 0.5], [-4, 0.5], [3, 0.5], [1, 0.5]], [[1, 0.25], [-1, 0.25], [-1, 0.25], [-2, 0.25], [2, 0.25], [1, 0.25], [1, 0.5]], [[-3, 0.25], [-1, 0.25], [-2, 0.25], [1, 0.25], [-4, 0.5], [1, 0.5]]]
...
add_note(solo, bass, blues_scale[6], note[1], beats_per_minute, 4.0)
